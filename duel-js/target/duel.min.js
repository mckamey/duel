var duel=function(B,l){function w(a){this.value=a}function j(a){switch(typeof a){case "object":return!a?0:x(a)?2:a instanceof w?5:a instanceof Date?4:3;case "function":return 1;case "undefined":return 0;default:return 4}}function p(a){return typeof a==="function"}function n(){this.value=n.FAST?"":[]}function y(a){var b,c;switch(j(a)){case 4:return""+a;case 0:return"";case 2:b=new n;for(var e=0,d=a.length;e<d;e++)c?b.append(", "):c=true,b.append(y(a[e]));return b.toString();case 3:b=new n;b.append("{");
for(e in a)a.hasOwnProperty(e)&&(c?b.append(", "):c=true,b.append(e,"=",y(a[e])));b.append("}");return b.toString()}return a}function q(a){x(a)||(a=["",a]);this.value=a}function s(a,b){switch(j(b)){case 2:if(b[0]==="")for(var c=1,e=b.length;c<e;c++)s(a,b[c]);else a.push(b);break;case 3:c=a[1];if(j(c)===3)for(e in b)b.hasOwnProperty(e)&&(c[e]=b[e]);else a.splice(1,0,b);break;case 4:c=a.length-1;c>0&&j(a[c])===4?a[c]=""+a[c]+b:b!==""&&a.push(""+b);break;case 0:break;default:a.push(b)}}function t(a,
b,c,e,d,f){var h=j(a[1])===3;if(a.length===(h?3:2))return m(a[a.length-1],b,c,e,d,f);for(var g=[""],h=h?2:1,i=a.length;h<i;h++)s(g,m(a[h],b,c,e,d,f));return g}function C(a,b,c,e,d,f){for(var h=1,g=a.length;h<g;h++){var i=a[h],k=i[1].test;if(j(i[1])===3&&k&&(p(k)&&(k=k(b,c,e,d)),!k))continue;return t(i,b,c,e,d,f)}return null}function L(a){j(a)!==2&&(a=["",a]);var b=function(b){try{var e=m(a,b,0,1,null);return new q(e)}catch(d){return new q("["+d+"]")}};b.getView=function(){return a};return b}function M(a){return typeof a!==
"string"?a:a.replace(/[&<>]/g,function(a){switch(a){case "&":return"&amp;";case "<":return"&lt;";case ">":return"&gt;";default:return a}})}function N(a){return typeof a!=="string"?a:a.replace(/[&<>"]/g,function(a){switch(a){case "&":return"&amp;";case "<":return"&lt;";case ">":return"&gt;";case '"':return"&quot;";default:return a}})}function D(a,b){var c=b[0]||"",e=b.length,d=1,f,h=O[c];if(c.charAt(0)==="!")b[0]==="!DOCTYPE"?a.append("<!DOCTYPE ",b[1],">"):a.append("<\!--",b[1],"--\>");else{if(c){a.append("<",
