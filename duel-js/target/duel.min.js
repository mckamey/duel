/*
 DUEL v0.9.4 http://duelengine.org
...
function(a){(a||n).write(""+this)};var S={accesskey:"accessKey",bgcolor:"bgColor",cellpadding:"cellPadding",cellspacing:"cellSpacing",checked:"defaultChecked","class":"className",colspan:"colSpan",contenteditable:"contentEditable",defaultchecked:"defaultChecked","for":"htmlFor",formnovalidate:"formNoValidate",hidefocus:"hideFocus",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",readonly:"readOnly",rowspan:"rowSpan",spellcheck:"spellCheck",tabindex:"tabIndex",usemap:"useMap",willvalidate:"willValidate"},
v={enctype:"encoding",onscroll:"DOMMouseScroll"},T={autocapitalize:1,autocomplete:1,autocorrect:1},Q=/^[\r\n]+/,R=/[\r\n]+$/;q.prototype.toDOM=function(a,b){4===k(a)&&(a=n.getElementById(a));var d;try{b&&(d=a,a=null),d=M(d||u(this.value[0]),this.value)}catch(f){var c=w(f);if(c instanceof q)return c.toDOM(a||d);d=n.createTextNode(""+c)}a&&a.parentNode&&a.parentNode.replaceChild(d,a);return d};q.prototype.reload=function(){var a=n;try{var b=this.toDOM();a.replaceChild(b,a.documentElement);if(a.createStyleSheet){for(var d=
b.firstChild;d&&"HEAD"!==(d.tagName||"");)d=d.nextSibling;for(var f=d&&d.firstChild;f;){if("LINK"===(f.tagName||""))f.href=f.href;f=f.nextSibling}}}catch(c){a=a.open("text/html"),a.write(""+this),a.close()}};return r}(document,window.ScriptEngineMajorVersion);
