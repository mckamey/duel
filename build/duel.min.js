var duel=function(x){function y(a){this.value=a}function j(a){switch(typeof a){case "object":return!a?0:a instanceof Array?2:a instanceof y?5:a instanceof Date?4:3;case "function":return 1;case "undefined":return 0;default:return 4}}function p(a){return typeof a==="function"}function n(){this.value=n.FAST?"":[]}function v(a){return a<10?"0"+a:a}function z(a){var b,c;switch(j(a)){case 4:if(a instanceof Date)return a.getUTCFullYear()+"-"+v(a.getUTCMonth()+1)+"-"+v(a.getUTCDate())+" "+v(a.getUTCHours())+
