...
11&&a.childNodes.length===1)a=a.firstChild;return a}var n=v.document;w.prototype.toString=function(){return this.value};var l;l=function(a,b,d,g,c,e){switch(k(a)){case 1:return a(b,d,g,c);case 2:var f=a[0]||"";switch(f){case "$for":a:{var h=a[1]||{};f=[""];var j;if(h.hasOwnProperty("count")){j=h.count;if(m(j))j=j(b,d,g,c);if(h.hasOwnProperty("data")){h=h.data;if(m(h))h=h(b,d,g,c)}else h=b;for(b=0;b<j;b++)p(f,q(a,h,b,j,null,e))}else{if(h.hasOwnProperty("in")){var i=h["in"];if(m(i))i=i(b,d,g,c);if(k(i)===
3){h=[];for(j in i)i.hasOwnProperty(j)&&h.push(j);b=0;for(j=h.length;b<j;b++)p(f,q(a,i[h[b]],b,j,h[b],e));a=f;break a}h=i}else{h=h.each;if(m(h))h=h(b,d,g,c)}b=k(h);if(b===2){b=0;for(j=h.length;b<j;b++)p(f,q(a,h[b],b,j,null,e))}else if(b!==0)f=q(a,h,0,1,null,e)}a=f}return a;case "$xor":return A(a,b,d,g,c,e);case "$if":return A(["$xor",a],b,d,g,c,e);case "$call":e=a[1];if(!e||!e.view)a=null;else{f=l(e.view,b,d,g,c);h=e.hasOwnProperty("data")?l(e.data,b,d,g,c):b;j=e.hasOwnProperty("index")?l(e.index,
b,d,g,c):d;i=e.hasOwnProperty("count")?l(e.count,b,d,g,c):g;b=e.hasOwnProperty("key")?l(e.key,b,d,g,c):c;d={};for(g=a.length-1;g>=2;g--){c=a[g];if((e=c[1]||{})&&e.name)d[e.name]=c}a=f&&m(f.getView)?l(f.getView(),h,j,i,b,d):null}return a;case "$part":f=(a[1]||{}).name;f=e&&e.hasOwnProperty(f)?e[f]:a;return q(f,b,d,g,c)}f=[f];h=1;for(j=a.length;h<j;h++)p(f,l(a[h],b,d,g,c,e));return f;case 3:e={};for(f in a)if(a.hasOwnProperty(f))e[f]=l(a[f],b,d,g,c);return e}return a};var z=v.duel=function(a){return m(a)&&
m(a.getView)?a:I(a)};z.raw=z.raw=function(a){return new w(a)};var L={area:true,base:true,basefont:true,br:true,col:true,frame:true,hr:true,img:true,input:true,isindex:true,keygen:true,link:true,meta:true,param:true,source:true,wbr:true};o.FAST=!v.ScriptEngineMajorVersion;o.prototype.append=function(a,b,d){if(o.FAST){this.value+=a;if(b!=null){this.value+=b;if(d!=null)this.value+=d}}else this.value.push.apply(this.value,arguments)};o.prototype.clear=function(){this.value=o.FAST?"":[]};o.prototype.toString=
function(){return o.FAST?this.value:this.value.join("")};t.prototype.toString=function(){var a;var b=this.value;try{var d=new o;B(d,b);a=d.toString()}catch(g){a="["+g+"]"}return a};var O={rowspan:"rowSpan",colspan:"colSpan",cellpadding:"cellPadding",cellspacing:"cellSpacing",tabindex:"tabIndex",accesskey:"accessKey",hidefocus:"hideFocus",usemap:"useMap",maxlength:"maxLength",readonly:"readOnly",contenteditable:"contentEditable"},s={enctype:"encoding",onscroll:"DOMMouseScroll"},P={onblur:true,onchange:true,
onclick:true,ondblclick:true,onerror:true,onfocus:true,onkeydown:true,onkeypress:true,onkeyup:true,onload:true,onmousedown:true,onmouseenter:true,onmouseleave:true,onmousemove:true,onmouseout:true,onmouseover:true,onmouseup:true,onresize:true,onscroll:true,onselect:true,onsubmit:true,onunload:true},M=/^[\n\r]+/,N=/[\n\r]+$/;t.prototype.toDOM=t.prototype.toDOM=function(){try{return H(r(this.value[0]),this.value)}catch(a){return n.createTextNode("["+a+"]")}};return z}(window);